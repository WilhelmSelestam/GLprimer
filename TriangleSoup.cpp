...
void TriangleSoup::createBox(float xsize, float ysize, float zsize) {
    ...
    // coordinate xyz, normal xyz, texcoords st
    const GLfloat vertex_array_data[] = {
        -xsize, -ysize, zsize, 0.0f, 0.0f, 1.0f, 1/4, 0,  // Vertex 0
        -xsize, -ysize, zsize, -1.0f, 0.0f, 0.0f, 0, 1/3,  // Vertex 1
        -xsize, -ysize, zsize, 0.0f, -1.0f, 0.0f, 1, 1/3,  // Vertex 2

        xsize, -ysize, zsize, 0.0f, 0.0f, 1.0f, 1/2, 0,  // Vertex 3
        xsize, -ysize, zsize, 1.0f, 0.0f, 0.0f, 3/4, 1/3,  // Vertex 4
        xsize, -ysize, zsize, 0.0f, -1.0f, 0.0f, 3/4, 1/3,  // Vertex 5

        xsize, ysize, zsize, 0.0f, 0.0f, 1.0f, 1/2, 1/3,  // Vertex 6
        xsize, ysize, zsize, 1.0f, 0.0f, 0.0f, 1/2, 1/3,  // Vertex 7
        xsize, ysize, zsize, 0.0f, 1.0f, 0.0f, 1/2, 1/3,  // Vertex 8

        -xsize, ysize, zsize, 0.0f, 0.0f, 1.0f, 1/4, 1/3,  // Vertex 9
        -xsize, ysize, zsize, -1.0f, 0.0f, 0.0f, 1/4, 1/3,  // Vertex 10
        -xsize, ysize, zsize, 0.0f, 1.0f, 0.0f, 1/4, 1/3,  // Vertex 11

        xsize, -ysize, -zsize, 1.0f, 0.0f, 0.0f, 3/4, 2/3,  // Vertex 12
        xsize, -ysize, -zsize, 0.0f, 0.0f, -1.0f, 1/2, 1,  // Vertex 13
        xsize, -ysize, -zsize, 0.0f, -1.0f, 0.0f, 3/4, 2/3,  // Vertex 14

        xsize, ysize, -zsize, 1.0f, 0.0f, 0.0f, 1/2, 2/3,  // Vertex 15
        xsize, ysize, -zsize, 0.0f, 0.0f, -1.0f, 1/2, 2/3,  // Vertex 16
        xsize, ysize, -zsize, 0.0f, 1.0f, 0.0f, 1/2, 2/3,  // Vertex 17

        -xsize, ysize, -zsize, 0.0f, 0.0f, -1.0f, 1/4, 2/3,  // Vertex 18
        -xsize, ysize, -zsize, -1.0f, 0.0f, 0.0f, 1/4, 2/3,  // Vertex 19
        -xsize, ysize, -zsize, 0.0f, 1.0f, 0.0f, 1/4, 2/3,  // Vertex 20

        -xsize, -ysize, -zsize, 0.0f, 0.0f, -1.0f, 1/4, 1,  // Vertex 21
        -xsize, -ysize, -zsize, -1.0f, 0.0f, 0.0f, 0, 2/3,  // Vertex 22
        -xsize, -ysize, -zsize, 0.0f, -1.0f, 0.0f, 1, 2/3   // Vertex 23
